...
white_output = 'challenge_video_output3.mp4'
...
if (MAKEGIF==True):
    ...
    clip = (VideoFileClip("output_images/challenge_video_output.mp4")
            .subclip(6)
            .resize(0.3))
    clip.write_gif("output_images/challenge_video_output.gif")
